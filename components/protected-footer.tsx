...
export default function ProtectedFooter() {
  ...
  // Hide footer on auth pages, profile pages, and chatbot page
  const hideOn = ['/login', '/register', '/forgot-password', '/confirm-registration', '/profile', '/settings', '/badges', '/chatbot' , '/reset-password'];
  ...
  if (shouldHide || isDestinasiDetail || isArtikelDetail || isForumDetail || isResetPassword) {
    return null;
  }
