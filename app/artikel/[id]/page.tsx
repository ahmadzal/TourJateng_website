      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12 text-gray-900">
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 lg:gap-4">
            <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            ...
            <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
